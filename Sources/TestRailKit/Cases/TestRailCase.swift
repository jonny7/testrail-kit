...
public struct TestRailCase: TestCase {
  ...
  public init(
    id: Int? = nil, title: String, sectionId: Int, templateId: Int, typeId: Int, priorityId: Int,
    milestoneId: Int?, refs: String?, createdBy: Int, createdOn: Date, updatedBy: Int,
    updatedOn: Date, estimate: String?, estimateForecast: String?, suiteId: Int, displayOrder: Int,
    customAutomationType: Int?, customTestrailLabel: String?, customPreconds: String?,
    customSteps: String?, customExpected: String?, customStepsSeparated: [TestRailStep]?,
    customMission: String?, customGoals: String?
  ) {
    self.id = id
    self.title = title
