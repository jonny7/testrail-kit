...
class ResultFieldTests: XCTestCase {

    static var utilities = ResultFieldUtilities()
    ...
    func testGetResultFields() {
        ...
        XCTAssertNoThrow(requestComplete = try Self.utilities.client.action(resource: ResultFieldResource.get))
            ...
            XCTAssertEqual(
                .head(
                    .init(
                        ...
                        method: .GET,
                        uri: "/index.php?/api/v2/get_result_fields",
                        headers: .init([
        ...
        responseBuffer.writeString(Self.utilities.resultFieldsResponse)
        ...
        XCTAssertEqual(response.first?.systemName, "custom_step_results")
    }
}
